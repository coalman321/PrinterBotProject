 ...
 * private BNO055 sensor;
	...
	public void robotInit() {
  		sensor = BNO055.getInstance(BNO055.opmode_t.OPERATION_MODE_NDOF,BNO055.vector_type_t.VECTOR_EULER);
...
//					+ ", next: " + nextTime);
	...
	public GyroBase createGyroX() {
		return new GyroAdapter(xyz[0], 0, 360, false) {@Override protected double getSensorValue() {return xyz[0];}};
	}
